...
import org.exolab.xml.XercesSerializer;
...
public class XercesJDK5OutputFormat implements OutputFormat {
  ...
  public XercesJDK5OutputFormat() {
    try {
      ...
      throw new RuntimeException(Messages.format("conf.failedInstantiateOutputFormat", "com.sun.org.apache.xml.internal.serialize.OutputFormat", except));
    }
  }
