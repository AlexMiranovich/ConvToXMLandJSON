...
public class NamedNativeQueryDescriptor extends XMLClassDescriptorImpl {
  ...
  public NamedNativeQueryDescriptor() {
    ...
    this._xmlName = "named-native-query";
    ...
    desc = new XMLFieldDescriptorImpl(String.class, "_resultClass", "result-class", NodeType.Attribute);
    desc.setImmutable(true);
    handler = new XMLFieldHandler()
    {
      public Object getValue(Object object)
    ...
    typeValidator.setWhiteSpace("preserve");
    desc.setValidator(fieldValidator);
    desc = new XMLFieldDescriptorImpl(String.class, "_resultSetMapping", "result-set-mapping", NodeType.Attribute);
    desc.setImmutable(true);
    handler = new XMLFieldHandler()
    {
      public Object getValue(Object object)
